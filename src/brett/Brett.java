...
public class Brett implements Cloneable {
    ...
    public class Zug {
        ...
        private Class<? extends Figur> bauernVerwandlungsClass;
        ...
        /**
         * Erzeuge einen Zug mit der Schachnotation als String und der Farbe der Figur.
         * Genau wie beim anderen Konstruktor müssen die Figuren auch dort stehen, wo
         * sie ihren Zug vollziehen sollen.
         */
        public Zug(String notation, Figur.Farbe farbe) {
            switch (notation) {
                case "0-0" -> {
                    switch (farbe) {
                        case Figur.Farbe.WEISS -> {
                            this.von = new Position(5, 8);
                            this.nach = new Position(7, 8);
                        }
                        case Figur.Farbe.SCHWARZ -> {
                            this.von = new Position(5, 1);
                            this.nach = new Position(7, 1);
                        }
                    }
                }
                case "0-0-0" -> {
                    switch (farbe) {
                        case Figur.Farbe.WEISS -> {
                            this.von = new Position(5, 8);
                            this.nach = new Position(3, 8);
                        }
                        case Figur.Farbe.SCHWARZ -> {
                            this.von = new Position(5, 1);
                            this.nach = new Position(3, 1);
                        }
                    }
                }
                default -> {
                    ...
                    int vonX = notation.charAt(0) - 'a' + 1;
                    int vonY = 8 - notation.charAt(1) + '1';
                    int nachX = notation.charAt(3) - 'a' + 1;
                    int nachY = 8 - notation.charAt(4) + '1';

                    this.von = new Position(vonX, vonY);
                    this.nach = new Position(nachX, nachY);

                    if (notation.length() > 5) {
                        switch (notation.charAt(5)) {
                            case 'D' -> bauernVerwandlungsClass = Dame.class;
                            case 'T' -> bauernVerwandlungsClass = Turm.class;
                            case 'L' -> bauernVerwandlungsClass = Laeufer.class;
                            case 'S' -> bauernVerwandlungsClass = Springer.class;
                            default -> {
                            }
                        }
                    }
        ...
        /**
         * @return die Schachnotation des Zuges.
         */
        public String getNotation() {
            ...
            if (enPassantBauer != null) {
                ...
                notation += bauernVerwandlungsClass.getSimpleName().charAt(0);
         ...
         *
         * @param graphisch ob das Brett graphisch veraendert und die Schachnotation
        ...
        public Zug fuehreAus(boolean graphisch) {
            ...
            if (enPassantBauer != null) {
                ...
                if (graphisch) {
                     ...
                     * und gespiechert.
                     */
                    if (bauernVerwandlungsClass == null) {
                        bauernVerwandlungsClass = spielerDerFarbe(aktuelleFarbe())
                                .getNewBauerClass();
                    }

                    try {
                        verwandlungsFigur = bauernVerwandlungsClass.getConstructor(Brett.class,
     ...
     *
     * @param brettPanel das Panel, auf dem das Brett angezeigt werden soll.
     */
    ...
    /**
     * @return den Timer des weissen Spielers, oder null.
     */
    public SchachUhrThread getWeissTimer() {
        return timer[0];
    }

    /**
     *
     * @return den Timer des schwarzen Spielers, oder null.
     */
    public SchachUhrThread getSchwarzTimer() {
        return timer[1];
    }
     ...
     * es.
     *
     * @param spieler1 Weisser Spieler
     * @param spieler2 Schwarzer spieler
     */
     ...
     * @param spieler1 Weisser Spieler
     * @param spieler2 Schwarzer spieler
     * @param timer1   Timer von spieler1
     * @param timer2   Timer von spieler2
     */
    public void reset(Spieler spieler1, Spieler spieler2,
     ...
     *
     * @param farbe Die Farbe, die auf Schach geprueft werden soll.
     * @param sound ob ein Sound abgespielt werden soll
     ...
     *
     * @param pos   die zu pruefende Position
     * @param farbe die Farbe des Spielers, der pruefen moechte
    ...
    /**
     * Prüft ob die Partie noch aktiv ist.
     */
    public boolean spielAktiv() {
        return brettSituation(spielerDerFarbe(aktuelleFarbe())) == Situation.NORMAL;
    }

    /**
     * Gibt die aktuelle Brettsituation des pruefenden Spielers
     *
     * @param pruefer Der pruefende Spieler
     ...
     * Beendet dasSpiel
     *
     * @param siegerFarbe Die Fare des Siegers, null wenn Remis
     * @param grund       warum das Spiel zu Ende ist. wenn null, wird keine MsgBox
     *                    angezeigt
     */
    public synchronized void endGame(Farbe siegerFarbe, String grund) {
        ...
        if (siegerFarbe == null) {
            grund = "Remis wegen " + grund + "!";
        } else {
            grund = siegerFarbe.toString() + " gewinnt wegen " + grund + "!";
        ...
        JOptionPane.showMessageDialog(null, grund, "Partie beendet!",
     ...
     *
     * @param pruefer Der pruefende Spieler
     * @param sich    Ob er sich (true) oder seinen Gegner (false) haben will
     * @return den Spieler
     */
