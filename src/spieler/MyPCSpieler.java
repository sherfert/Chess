...
public class MyPCSpieler extends PCSpieler {
     ...
     *
     * @param brett         Das Brett auf dem der Spieler spielt.
     * @param schwierigkeit Eine nicht-negative Zahl fuer die Schwierigkeit. Bereits 5 ist
     *                      relativ rechenintensiv.
     * @param agressiv      Ob der PC-Spieler agressiv spielen soll oder nicht.
     */
    ...
    /**
     * @return die Schwierigkeit des Spielers.
     */
    ...
    /**
     * @return ob der Spieler agressiv ist.
     */
     ...
     *
     * @param wert Der tiefe Wert des Zuges
     * @param zug  Der Zug
     */
    ...
    private class MyPCSpielerThread extends Thread {
         ...
         *
         * @param self           Eine Spieler-Referenz auf den eigenen Klon auf dem Brett,
         *                       das dem Thread fuer Berechnungen zugrundeliegt
         * @param von            Anfangs-Index
         * @param nach           Der erste nicht mehr (!!) zu betrachtende Index
         * @param moeglicheZuege Liste von moeglichen Zuegen, die, wenn sie uebernommen
         *                       werden sollen, auf dem Brett von self erstellt worden sein
         *                       muessen
         * @param uebernehmen    ob die Liste von moeglichen Zuegen uebernommen (true) oder
         ...
         *
         * @param tiefe Wie viele Schritte in die Berechnung einfliessen sollen
         * @param alpha Alpha-Grenze, bei initialem Aufruf theoretisch -unendlich
         * @param beta  Beta-Grenze, bei initialem Aufruf theoretisch +unendlich
         * @param my    Ob gerade die eigenen (true) oder die gegnerischen (false)
